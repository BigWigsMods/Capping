...
--L.takenTheFlagTrigger = "^¡(.+) ha tomado la bandera!"
--L.hasTakenTheTrigger = "ha tomado"
--L.upgradeToTrigger = "Mejorar a"
...
--L.northWest = "Muralla noroeste"
--L.southWest = "Muralla suroeste"
--L.south = "Muralla sur"
